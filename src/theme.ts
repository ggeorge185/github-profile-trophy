export const COLORS: { [name: string]: Theme } = {
  ...
  negative: {
    ...
    TEXT: "#FFFFFF",
    LAUREL: "#FFFFFF",
    SECRET_RANK_1: "#000000",
    SECRET_RANK_2: "#000000",
    SECRET_RANK_3: "#000000",
    SECRET_RANK_TEXT: "#FFFFFF",
    NEXT_RANK_BAR: "#FFFFFF",
    S_RANK_BASE: "#000000",
    S_RANK_SHADOW: "#000000",
    S_RANK_TEXT: "#FFFFFF",
    A_RANK_BASE: "#000000",
    A_RANK_SHADOW: "#000000",
    A_RANK_TEXT: "#FFFFFF",
    B_RANK_BASE: "#000000",
    B_RANK_SHADOW: "#000000",
    B_RANK_TEXT: "#FFFFFF",
    DEFAULT_RANK_BASE: "#000000",
    DEFAULT_RANK_SHADOW: "#000000",
